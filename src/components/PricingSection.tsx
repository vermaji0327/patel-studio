        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {catalogueItems.map((item, idx) => (
            <motion.article
              ...
              className="relative bg-gradient-to-br from-romantic-pink/20 via-romantic-lavender/20 to-white/30 rounded-2xl p-4 shadow-lg hover:shadow-2xl border border-white/60 transform transition-all duration-300 hover:-translate-y-2 cursor-pointer"
